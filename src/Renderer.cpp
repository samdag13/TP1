...
void Renderer::setup() {
	...
	togglegroup.add(toggle1.setup("Dessin vectoriel", false));
	togglegroup.add(toggle2.setup("Arbre fractal", false));
	togglegroup.add(toggle3.setup("Modele 3D", false));
	togglegroup.add(bouton4.setup("Screenshot"));
	togglegroup.add(bouton5.setup("Importer une image"));
...
void Renderer::update() {
	...
	else if (bouton4)
	{
		...
		string file_name = "Votre image!" + time_stamp + ".png";
